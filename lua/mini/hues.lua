...
MiniHues.apply_palette = function(palette, plugins, opts)
  ...
  hi('CursorLineNr',   { fg=p.accent,  bg=nil,       bold=false })
  ...
  hi('FloatTitle',     { fg=p.accent,  bg=p.bg_edge, bold=false })
  ...
  hi('MatchParen',     { fg=nil,       bg=p.bg_mid2, bold=false })
  ...
  hi('NonText',        { fg=p.fg_mid2, bg=nil })
  ...
  hi('PmenuMatch',     { fg=nil,       bg=nil,       bold=false })
  hi('PmenuMatchSel',  { fg=nil,       bg=nil,       bold=false,   blend=0, reverse=true })
  ...
  hi('QuickFixLine',   { fg=nil,       bg=nil,       bold=false })
  ...
  hi('Statement',      { fg=p.fg,      bg=nil,         bold=false })
  hi('StorageClass',   { link='Type' })
  hi('String',         { fg=p.green,   bg=nil })
  hi('Structure',      { link='Type' })
  hi('Tag',            { link='Special' })
  hi('Todo',           { fg=p.accent,  bg=p.accent_bg, bold=false })
  hi('Type',           { fg=p.fg,      bg=nil })
  hi('Typedef',        { link='Type' })

  -- Other community standard
  hi('Bold',       { fg=nil, bg=nil, bold=false })
  hi('Italic',     { fg=nil, bg=nil, italic=false })
  ...
  -- Git commit
  hi('gitcommitBranch',        { fg=p.orange, bg=nil, bold=false })
  hi('gitcommitComment',       { link='Comment' })
  hi('gitcommitDiscarded',     { link='Comment' })
  hi('gitcommitDiscardedFile', { fg=p.yellow, bg=nil, bold=false })
  ...
  hi('gitcommitSelectedFile',  { fg=p.green,  bg=nil, bold=false })
  ...
  hi('@text.strong',    { fg=nil, bg=nil, bold=false         })
  hi('@text.emphasis',  { fg=nil, bg=nil, italic=false       })
  ...
  hi('@keyword.return', { fg=p.orange, bg=nil, bold=false })
  ...
  if vim.fn.has('nvim-0.10') == 1 then
    ...
    hi('@keyword.import',    { fg=p.blue, bg=nil, bold=false })
    hi('@keyword.storage',   { fg=p.fg,   bg=nil, bold=false })
    hi('@keyword.repeat',    { link='@keyword' })
    -- @keyword.return
    hi('@keyword.debug',     { fg=p.cyan, bg=nil, bold=false })
    hi('@keyword.exception', { link='@keyword' })

    hi('@keyword.conditional',         { link='@keyword' })
    hi('@keyword.conditional.ternary', { link='keyword' })

    hi('@keyword.directive',        { fg=p.blue, bg=nil, bold=false })
  ...
  if has_integration('nvim-mini/mini.nvim') or has_integration('echasnovski/mini.nvim') then
    ...
    hi('MiniFilesTitleFocused',   { fg=p.fg, bg=p.bg_edge, bold=false })

    hi('MiniHipatternsFixme', { fg=p.bg, bg=p.red,    bold=false })
    hi('MiniHipatternsHack',  { fg=p.bg, bg=p.yellow, bold=false })
    hi('MiniHipatternsNote',  { fg=p.bg, bg=p.cyan,   bold=false })
    hi('MiniHipatternsTodo',  { fg=p.bg, bg=p.blue,   bold=false })
    ...
    hi('MiniJump2dSpot',       { fg=p.fg_edge2, bg=p.bg_edge2, bold=false, nocombine=true })
    ...
    hi('MiniStarterHeader',     { fg=p.accent,  bg=nil, bold=false })
    hi('MiniStarterInactive',   { link='Comment' })
    hi('MiniStarterItem',       { link='Normal' })
    hi('MiniStarterItemBullet', { fg=p.fg_mid2, bg=nil })
    hi('MiniStarterItemPrefix', { fg=p.yellow,  bg=nil, bold=false })
    hi('MiniStarterSection',    { fg=p.purple,  bg=nil })
    hi('MiniStarterQuery',      { fg=p.green,   bg=nil, bold=false })
    ...
    hi('MiniStatuslineModeCommand', { fg=p.bg,     bg=p.yellow, bold=false })
    hi('MiniStatuslineModeInsert',  { fg=p.bg,     bg=p.azure,  bold=false })
    hi('MiniStatuslineModeNormal',  { fg=p.bg,     bg=p.fg,     bold=false })
    hi('MiniStatuslineModeOther',   { fg=p.bg,     bg=p.cyan,   bold=false })
    hi('MiniStatuslineModeReplace', { fg=p.bg,     bg=p.red,    bold=false })
    hi('MiniStatuslineModeVisual',  { fg=p.bg,     bg=p.green,  bold=false })

    hi('MiniSurround', { link='IncSearch' })

    hi('MiniTablineCurrent',         { fg=p.accent,  bg=p.bg,      bold=false })
    hi('MiniTablineFill',            { link='MiniTablineHidden' })
    hi('MiniTablineHidden',          { fg=p.fg_mid,  bg=p.bg_edge })
    hi('MiniTablineModifiedCurrent', { fg=p.bg,      bg=p.accent,  bold=false })
    hi('MiniTablineModifiedHidden',  { fg=p.bg_edge, bg=p.fg_mid })
    hi('MiniTablineModifiedVisible', { fg=p.bg_edge, bg=p.fg_mid,  bold=false })
    hi('MiniTablineTabpagesection',  { fg=p.bg,      bg=p.green,   bold=false })
    hi('MiniTablineTrunc',           { fg=p.accent,  bg=p.bg_edge, bold=false })
    hi('MiniTablineVisible',         { fg=p.fg_mid,  bg=p.bg_edge, bold=false })

    hi('MiniTestEmphasis', { fg=nil,     bg=nil, bold=false })
    hi('MiniTestFail',     { fg=p.red,   bg=nil, bold=false })
    hi('MiniTestPass',     { fg=p.green, bg=nil, bold=false })
  ...
  if has_integration('akinsho/bufferline.nvim') then
    ...
    hi('BufferLineBufferSelected',      { fg=p.fg,      bg=nil,     bold=false })
    ...
    hi('BufferLineTabSelected',         { fg=p.bg,      bg=p.green, bold=false })
  end
  ...
  if has_integration('folke/lazy.nvim') then
    ...
    hi('LazyH1',           { fg=p.accent, bg=p.bg_mid2, bold=false })
  end
  ...
  if has_integration('folke/trouble.nvim') then
    hi('TroubleCount',           { fg=p.accent,  bg=nil, bold=false })
    hi('TroubleFoldIcon',        { fg=p.accent,  bg=nil, bold=false })
  ...
  if has_integration('ggandor/leap.nvim') then
    hi('LeapMatch',          { fg=p.green,  bg=nil, bold=false, nocombine=true, underline=true })
    hi('LeapLabel',          { fg=p.yellow, bg=nil, bold=false, nocombine=true })
    hi('LeapLabelSelected',  { fg=p.cyan,   bg=nil, bold=false, nocombine=true })
  ...
  if has_integration('glepnir/lspsaga.nvim') then
    ...
    hi('LspSagaCodeActionTitle',   { fg=p.azure,  bg=nil, bold=false })
  ...
  if has_integration('hrsh7th/nvim-cmp') then
    ...
    hi('CmpItemAbbrMatch',      { fg=nil,  bg=nil, bold=false })
    hi('CmpItemAbbrMatchFuzzy', { fg=nil,  bg=nil, bold=false })
  ...
  if has_integration('justinmk/vim-sneak') then
    ...
    hi('SneakLabel', { fg=p.bg, bg=p.orange, bold=false })
  end
  ...
  if has_integration('NeogitOrg/neogit') then
    ...
    hi('NeogitHunkHeaderHighlight', { fg=p.accent, bg=nil, bold=false })
  ...
  if has_integration('nvim-neo-tree/neo-tree.nvim') then
    ...
    hi('NeoTreeGitConflict',          { fg=p.orange,  bg=nil, bold=false })
    ...
    hi('NeoTreeRootName',             { fg=p.accent,  bg=nil, bold=false })
  ...
  if has_integration('nvim-telescope/telescope.nvim') then
    ...
    hi('TelescopeMatching',       { fg=nil,      bg=nil, bold=false })
  ...
  if has_integration('nvim-tree/nvim-tree.lua') then
    hi('NvimTreeExecFile',     { fg=p.green,   bg=nil,       bold=false })
    ...
    hi('NvimTreeRootFolder',   { fg=p.accent,  bg=nil,       bold=false })
    hi('NvimTreeSpecialFile',  { fg=p.accent,  bg=nil,       underline=true })
    hi('NvimTreeSymlink',      { fg=p.blue,    bg=nil,       bold=false })
    hi('NvimTreeWindowPicker', { fg=p.fg,      bg=p.bg_mid2, bold=false })
  end
  ...
  if has_integration('OXY2DEV/helpview.nvim') then
    ...
    hi('HelpviewTaglink',      { fg=p.accent, bg=nil,      bold=false })
  ...
  if has_integration('phaazon/hop.nvim') then
    hi('HopNextKey',   { fg=p.green,   bg=nil, bold=false, nocombine=true })
    hi('HopNextKey1',  { fg=p.orange,  bg=nil, bold=false, nocombine=true })
    hi('HopNextKey2',  { fg=p.fg_mid,  bg=nil, bold=false, nocombine=true })
    hi('HopPreview',   { fg=p.yellow,  bg=nil, bold=false, nocombine=true })
  ...
  if has_integration('rcarriga/nvim-dap-ui') then
    ...
    hi('DapUIModifiedValue',           { fg=p.orange, bg=nil, bold=false })
    ...
    hi('DapUIBreakpointsCurrentLine',  { fg=p.green,  bg=nil, bold=false })
  ...
  if has_integration('rlane/pounce.nvim') then
    hi('PounceMatch',      { fg=p.bg, bg=p.fg,      bold=false, nocombine=true })
    hi('PounceGap',        { fg=p.bg, bg=p.bg_mid2, bold=false, nocombine=true })
    hi('PounceAccept',     { fg=p.bg, bg=p.yellow,  bold=false, nocombine=true })
    hi('PounceAcceptBest', { fg=p.bg, bg=p.green,   bold=false, nocombine=true })
  end

  if has_integration('romgrk/barbar.nvim') then
    hi('BufferCurrent',        { fg=p.accent, bg=p.bg,      bold=false })
    hi('BufferCurrentIcon',    { fg=nil,      bg=p.bg })
    hi('BufferCurrentIndex',   { link='BufferCurrentIcon' })
    hi('BufferCurrentMod',     { fg=p.accent, bg=p.bg_mid,  bold=false })
    hi('BufferCurrentSign',    { link='BufferCurrent' })
    hi('BufferCurrentTarget',  { fg=p.accent, bg=p.bg_mid2, bold=false })
    ...
    hi('BufferTabpages',       { fg=p.bg,     bg=p.green,   bold=false })
    hi('BufferTabpageFill',    { link='Normal' })

    hi('BufferVisible',        { fg=p.fg,     bg=p.bg,      bold=false })
    hi('BufferVisibleIcon',    { fg=nil,      bg=p.bg })
    hi('BufferVisibleIndex',   { link='BufferVisibleIcon' })
    hi('BufferVisibleMod',     { fg=p.fg,     bg=p.bg_mid,  bold=false })
    hi('BufferVisibleSign',    { link='BufferVisible' })
    hi('BufferVisibleTarget',  { fg=p.fg,     bg=p.bg_mid2, bold=false })
  end
  ...
  if has_integration('williamboman/mason.nvim') then
    ...
    hi('MasonHeader',                      { fg=p.bg,     bg=p.azure,   bold=false })
    hi('MasonHeaderSecondary',             { fg=p.bg,     bg=p.blue,    bold=false })
    ...
    hi('MasonMutedBlockBold',              { fg=p.bg,     bg=p.bg_mid2, bold=false })
  end
